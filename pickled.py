...
app.config.update(
    ...
    SESSION_COOKIE_NAME='__Secure-pickled-session'  # Prefisso speciale per cookie sicuri
)
            ...
            for filename in sorted(os.listdir(LOG_DIR), reverse=True):
                if filename.startswith('events.') and filename.endswith('.log') and filename != 'events.log':
                    with open(os.path.join(LOG_DIR, filename), 'r') as f:
                        archived_logs.append(escape(f"=== Log {filename} ===\n{f.read()}\n"))
...
<body>
    ...
    <div class="app-container">
		...
		<option value="juniper">Juniper JunOS</option>
            ...
            <!-- Aggiunta del versioning in fondo alla colonna -->

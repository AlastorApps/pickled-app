		    ...
		    <div style="display: flex; gap: 10px; align-items: center;">
		        <div style="position: relative;">
		            <input type="text" id="search-input" placeholder="Search devices..." 
		                   style="padding: 8px 30px 8px 10px; border: 1px solid #ddd; border-radius: 4px;"
		        ...
		        <button class="exp-btn" onclick="exportSwitchesToCSV()" style="padding: 8px 12px;">
		            <i class="fas fa-file-export"></i> Export CSV
		        </button>
		        <button class="backup-all-btn" onclick="backupAllSwitches()" style="padding: 8px 12px; margin: 0;">
		            <i class="fas fa-download"></i> Backup All
		        </button>
		        <button onclick="window.location.href='/logout'" style="background: #e74c3c; padding: 8px 12px;">
